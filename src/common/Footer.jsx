...
import mital from "../assets/images/thanks.png";
      ...
      <footer>
        <div className="mobile-itemright-footer" data-aos="fade-down">
          <div className="footer-box-right">
            <p className="mind-project">Thankyou For Visiting </p>
            {/* <div>
              <img src={mital} alt="thanks-img" />
            </div> */}
              ...
              <div className="row">
                <div className="col-xxl-5 col-xl-5 col-lg-5">
                  ...
                  <div className="contact-footer">
                    ...
                    <Link to="mailto:biogi@mail.com">patilmital4@gmail.com</Link>
                  </div>
                  <div className="contact-footer">
                    <img src={LocationSvg} alt="location_svg" />
                    <p>Shirpur , Dist-Dhule, Maharashtra, India </p>
                  </div>
                </div>
