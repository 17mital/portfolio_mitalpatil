          ...
          <div className="row section-two-row">
            ...
            <div className="col-xxl-6 col-xl-6 col-lg-6">
              ...
              <h5 className="self-taught" data-aos="fade-up">
                <span>I'm Happy to share my projects Here ! </span>
              Your feedback and ideas are invaluable to me, and I'm always open to hearing new perspectives. If you have suggestions for improvement or creative contributions, feel free to reach out. Let's collaborate and make these projects even better together!
              </h5>
