          ...
          <div className="section">
            <ul className="case-study-wrapper">
              {[
                ...
                >
                  <Link to="/single_portfolio2" className="hover-target">
                    {name}
                  </Link>
                </li>
              ))}
            ...
            <ul className="case-study-images">
              {[1, 2, 3, 4, 5].map((number, index) => (
                ...
                >
                  <div className="img-hero-background"></div>
                  <div className="dark-over-hero"></div>
                  <div className="hero-number-back">
                    {number.toString().padStart(2, "0")}
                  </div>
                  <div className="hero-number">
                    {number.toString().padStart(2, "0")}
                  </div>
                  {index === 0 && <div className="hero-number-fixed">05</div>}
                </li>
              ))}
            </ul>
          </div>
...
export default PortfolioPageSix;
